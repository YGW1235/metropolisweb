...
| 경로 | 브랜드 | 설명 | 운영 주소 |
| --- | --- | --- | --- |
| `apps/web` | 메트로폴리스 아고라 | 아테나와 포세이돈의 관점으로 나뉘어 사회적 의제를 토론하는 공개 토론 플랫폼 | https://www.metropolisagora.com |
...
non-www 주소(`https://metropolisagora.com`)는 대표 주소인 `https://www.metropolisagora.com`으로 리디렉션되는 보조 진입점으로 관리합니다. Vercel 기본 도메인은 운영 보조 주소로 유지합니다.
...
| `NEXT_PUBLIC_SITE_URL` | 운영 대표 도메인. 운영 환경은 `https://www.metropolisagora.com` |
...
Cloudflare에서는 `www.metropolisagora.com`을 대표 도메인으로 연결하고, `metropolisagora.com`은 `www` 주소로 리디렉션되도록 관리합니다.
...
- `https://www.metropolisagora.com` 접속 확인
